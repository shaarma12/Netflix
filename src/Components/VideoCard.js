...
const VideoCard = () => {
  ...
  console.log(card);
  return (
    <div className="flex bg-[#141414] flex-col items-center rounded-md scale-y-125  text-7xl absolute top-10 right-5 font-extrabold w-[20rem] z-50 h-[14rem] ml-10">
      {/* <img
      ...
      <div className="flex">
        <button className="bg-white rounded-full max-w-9 max-h-6 px-1 absolute top-40 left-4 hover:opacity-80 mr-2">
